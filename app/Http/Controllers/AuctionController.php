...
class AuctionController extends Controller
{
    public function store(Request $request)
    {
        $request->validate([
            ...
            // 'duration' => 'required|integer|min:1|max:168', // duration is now optional
        ]);
        ...
        // If duration is provided, use it (in minutes), else default to 5 minutes
        ...
        $auction->save();
        return redirect()->back()->with('success', 'Auction started and your NFT will be sold by the company.');
    }
