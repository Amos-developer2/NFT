<?php
    ...
    class AccountController extends Controller
    {
        ...
        /**
         * Switch account mode (Live/Demo).
         */
        public function switchMode(Request $request)
        {
            $request->validate([
                'account_mode' => 'required|in:Live,Demo',
            ]);
            $user = Auth::user();
            $user->account_mode = $request->account_mode;
            $user->save();
            return redirect()->route('account')->with('success', 'Account mode updated!');
        }
        /**
